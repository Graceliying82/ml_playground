"""
Linear Regression Model — Level 3: Real-World Application

This module wraps scikit-learn's LinearRegression with a clean interface
for training, prediction, and evaluation on real-world datasets.
...
class LinearRegressionModel:
    """A linear regression model wrapper for real-world data.
    ...
    def fit(self, X_train, y_train, feature_names=None):
        ...
        # Step 1: Import and create a LinearRegression instance
